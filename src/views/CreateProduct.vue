    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="text-center my-5">
          <button class="btn btn-outline-secondary px-5 me-3" type="button" @click="cancel">
            取消
          </button>
          <button class="btn btn-primary px-5" type="button" @click="createProduct">
            確認
          </button>
        </div>
      </div>
  ...
  methods: {
    ...
    openModal (isNew, type) {
      ...
      if (isNew) {
        ...
        this.temType = this.temProduct.type_group.find(item => item.id === type.id)
      }
      this.isNew = isNew
